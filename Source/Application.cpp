...
: mWindow(sf::VideoMode(1024, 768), "Felix Felicis", sf::Style::Close)
, mTextures()
, mFonts()
, mPlayer()
, mMusic()
...
{
	mStateStack.registerState<LogoState>(States::Logo);
	mStateStack.registerState<IntroState>(States::Intro);
	mStateStack.registerState<MenuState>(States::Menu);
	mStateStack.registerState<GameState>(States::Game);
	mStateStack.registerState<PauseState>(States::Pause);
	mStateStack.registerState<OutroState>(States::Outro);
